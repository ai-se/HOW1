...
in some domains, no such model exists or is readily accessible. For example, this whole paper
...
HOW is a variant of GALE that does not need a underlying domain model.
