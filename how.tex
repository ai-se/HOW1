...
\subsection{Testing for Grainer Causality}
...
In the literature, there are two main definitions of causality: Hill's H-causality
and Grainer's G-casualty. 
...
in different places.
\ee
It is hard to demonstrate H-causality in software. For example, Hill's criteria emphasises repeatability and laboratory studies-- both of which are
...
for consistency is easier to achieve in studies of small closed systems (e.g. bacteria in a petri dish)
than in large socio-technical systems (e.g. open source projects). As Lofti Zadeh
commented: ``as complexity rises, precise statements lose meaning and meaningful statements lose precision''~\cite{zadeh.
