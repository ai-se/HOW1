...
\subsection{Accessing a Trustworthy model}
The premise of this work is that we do {\em not} have
a ready-to-use 
...
if our mutations to test suites
  minimize
test suite size while maximizing the number of statements covered~\cite{}
